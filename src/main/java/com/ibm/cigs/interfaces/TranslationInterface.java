...
public interface TranslationInterface {
	...
	/**
    *
    * @param ip represents the string whose language type is to be found
    ...
    **/
	...
	/**
    *
    * @param ip represents the string to be translated to english
    ...
    **/
	...
	/**
    *
    * @param ip represents the String which is to be translated to original language
    * @return string translated to English from the original language
    * 
    **/
